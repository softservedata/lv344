...
//	private void initAlertMessageSuccess() {
...
//	}
	...
	// alertMessage
	public WebElement getAlertMessageDenger() {
		return alertMessage;
	}

    public String getAlertMessageDengerText() {
        return getAlertMessageDenger().getText();
    }
    
    //dengerMessage
    public WebElement getAlertMessageSuccess() {
		return alertMessage;
	}

    public String getAlertMessageSuccessText() {
        return getAlertMessageSuccess().getText();
    }
