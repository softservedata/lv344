...
public class ConnectorJDBC {
	...
	// private static String URL
	// ="jdbc:jtds:sqlserver://ssu-oms/_067_OMS1;instance=SQLEXPRESS;"; //
	// 192.168.195.239
	//
	// MySQL
...
//	private static String URL = "jdbc:mysql://192.168.103.191:3306/opencart";
	private static String URL = "jdbc:mysql://localhost:3306/opencart";
//	private static String URL = "jdbc:mysql://localhost:3306/lv344";
	//
	// PostgresSQL
	// private static String URL =
	...
	public static void main(String[] args) throws Exception {
		...
		//
		// Load the driver
		con = DriverManager.getConnection(URL, username, password);// without??
		if (con != null) {
		...
		// 'Tar%';");
		//
		//// st.execute("CREATE DATABASE lv304work;");
...
//		st.execute("DELETE FROM temp WHERE id=4;");
//		 st.execute("select * from temp;");
